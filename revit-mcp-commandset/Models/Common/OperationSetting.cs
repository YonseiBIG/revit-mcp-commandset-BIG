...
namespace RevitMCPCommandSet.Models.Common
{
    ...
    public enum ElementOperationType
    {
        ...
        /// <summary>
        /// Isolate elements (show only the selected elements)
        /// </summary>
        Isolate,
    ...
    public class OperationSetting
    {
        ...
        /// <summary>
        /// The action to perform, stored as the string value of the ElementOperationType enum
        /// </summary>
        [JsonProperty("action")]
        ...
        /// <summary>
        /// Element color (RGB format); defaults to red
        /// </summary>
