        ...
        private string GetParameterValueAsString(Parameter parameter)
        {
            ...
            switch (parameter.StorageType)
            {
                ...
                case StorageType.Integer:
                    ...
                    {
                        // Check whether this is a known boolean built-in parameter (only parameters confirmed to exist in Revit 2019)
                        ...
                        // Attempt to identify boolean parameters by parameter name
                        ...
                        {
                            // Check that the storage type is Integer and the value is 0 or 1
                        ...
                        // Attempt to identify boolean parameters via storage type and value string
                        if (parameter.StorageType == StorageType.Integer)
                        {
